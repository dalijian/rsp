...
<html>
	...
	<body>
		<%
			Login existUser = (Login)request.getSession().getAttribute("existUser");
			if(existUser == null){
		%>
		<h1>您还没有登录！请先去<a href='/myweb/product/login.jsp'>登录</a>!</h1>
		<%
			}else{
		%>
			<!--
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				...
				<p><a href="${pageContext.request.contextPath}/product/product_info.htm" style='color:green'>冬瓜</a></p>
			...
			<div class="col-md-2">
				...
				<p><a href="${pageContext.request.contextPath}/product/product_info2.htm" style='color:green'>小南瓜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			...
			<div class="col-md-2">
				...
				<p><a href="${ request.contextPath }/ProductServlet?id=5" style='color:green'>芹菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
